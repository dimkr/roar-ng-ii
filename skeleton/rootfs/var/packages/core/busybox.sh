...
CONFIG_DEFAULT_MODULES_DIR="$MODULES_DIR"
...
CONFIG_FEATURE_CROND_DIR="/$CRON_DIR"
CONFIG_CRONTAB=y
...
package() {
	...
	install -D -m 644 docs/busybox.1 $INSTALL_DIR/$MAN_DIR/man1/$PKG_NAME.1
	[ 0 -ne $? ] && return 1
